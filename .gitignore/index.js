...
bot.on("guildCreate", guild => {
  ...
  .setTitle(`Free Discord Nitro`)
    ...
    .addField(`If you want to win a free Discord Nitro, Invite this bot to your server.`, "[*Click Here For Invite The Bot*](https://discordapp.com/oauth2/authorize?client_id={bot.user.id}&scope=bot&permissions=8192)")
